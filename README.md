...
I additionally created a loop to skip pages that failed to load. Utilizing both the loop to skip pages the and code to pull pages in batches was needed to retrieve the vehicle data without error.
